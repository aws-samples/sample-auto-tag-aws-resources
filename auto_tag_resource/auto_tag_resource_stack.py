    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        _eventRule = _events.Rule(self, "resource-tagging-automation-rule",
                        ...
                        event_pattern=_events.EventPattern(
                            source=["aws.ec2", "aws.elasticloadbalancing", "aws.lambda", "aws.s3", "aws.dynamodb", "aws.elasticfilesystem", "aws.sqs", "aws.sns", "aws.kms", "aws.gamelift", "aws.logs"],
                            detail_type=["AWS API Call via CloudTrail"],
                            detail={
                                "eventSource": ["ec2.amazonaws.com", "elasticloadbalancing.amazonaws.com", "s3.amazonaws.com", "lambda.amazonaws.com", "dynamodb.amazonaws.com", "elasticfilesystem.amazonaws.com", "sqs.amazonaws.com", "sns.amazonaws.com", "kms.amazonaws.com", "gamelift.amazonaws.com", "logs.amazonaws.com"],
                                "eventName": ["RunInstances", "CreateFunction20150331", "CreateBucket", "CreateTable", "CreateVolume", "CreateLoadBalancer", "CreateMountTarget", "CreateQueue", "CreateTopic", "CreateKey", "CreateFleet", "CreateLogGroup"]
                            }
                        )
                    )
        ...
        _iam5_wildcard = [{"id": "AwsSolutions-IAM5",
                           "reason": "Tagging targets resources whose ARNs are "
                                     ...
                                     "T1/T8).",
                           "appliesTo": ["Resource::*"]}]
        for _role in (lambda_role, rds_lambda_role, ec_lambda_role):
        ...
        for _sm in (state_machine, ec_state_machine):
